  ...
  for(let i=0; i<child_nodes; i++) {
    ...
    switch (m) {
      case 0:
        ...
        break;
      case 1: // rotate
        rotate_value = Number(value1.value) || 30;
        universe.affineAdd(1,rotate_value,0);

        break;
      case 2: // scale 1
        scale_value1 = Number(value1.value) || 0.333;
        scale_value2 = Number(value1.value) || 0.333;
        universe.affineAdd(2,scale_value1,scale_value2);

        break;
      case 3: // scale 2
        scale_value1 = Number(value1.value) || 4.5;
        scale_value2 = Number(value2.value) || 4.5;
        universe.affineAdd(3,scale_value1,scale_value2);

        break;
      case 4: // shift
        shift_value1 = Number(value1.value) || 20;
        shift_value2 = Number(value2.value) || 20;
        universe.affineAdd(4,shift_value1,shift_value2);

        break;
      case 5: //skey_x;
        skew_x = Number(value1.value) || 20;
        universe.affineAdd(5,skew_x);

        break;
      case 6: //skey_y;
        skew_y = Number(value1.value) || -50;
